...
export const boardSlice  = createSlice({
    ...
    reducers: {
        ...
        handleKeyPress: (state, { payload }) => {
            ...
            } else if (editMode === EDIT_MODE.PENCIL_MARK) {
                const currentValue = state.cells[row][col].pencilMarks;
                state.cells[row][col].pencilMarks = currentValue.indexOf(keyPressed) != -1 
